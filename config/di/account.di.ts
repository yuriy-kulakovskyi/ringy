...
import { ACCOUNT_REPOSITORY, ACCOUNT_SERVICE, CREATE_ACCOUNT_USECASE, GET_ACCOUNT_BY_EMAIL_USECASE, GET_ME_USECASE, UPDATE_ACCOUNT_USECASE } from "@modules/account/domain/tokens/account.tokens";
...
import { GetAccountByEmailUseCase } from "@modules/account/application/usecases/get-account-by-email.usecase";
...
container.register(GET_ACCOUNT_BY_EMAIL_USECASE, {
  useClass: GetAccountByEmailUseCase
})